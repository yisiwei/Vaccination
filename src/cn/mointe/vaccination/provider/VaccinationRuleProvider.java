...
public class VaccinationRuleProvider extends ContentProvider {
	...
	private static final String AUTHORITIES = "cn.mointe.vaccination.providers.VaccinationRuleProvider";
	...
	static {
		...
		URI_MATCHER.addURI(AUTHORITIES, "vaccinationRule", ALL_ROW);
		URI_MATCHER.addURI(AUTHORITIES, "vaccinationRule/#", SINGLE_ROW);
	}
	...
	public String getType(Uri uri) {
		...
		switch (URI_MATCHER.match(uri)) {
		case ALL_ROW:
			return "vnd.android.cursor.dir/vaccinationRule";
		case SINGLE_ROW:
			return "vnd.android.cursor.item/vaccinationRule";
		default:
			throw new IllegalArgumentException("this is Unknown Uri:" + uri);
		}
	}
